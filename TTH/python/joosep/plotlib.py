...
varnames = {
    ...
    "avgdetabtag_coarse": r"average $\eta$ between b-tagged jets",
    ...
    "avgmassnonbtag":r"Avg mass of light jets [GeV]",
    "avgjetmass":r"Avg mass of jets [GeV]",
    "massjetlep":r"Mass of lep and closest jet [GeV]",
    "avgbtag":r"Avg jet btag",
    "avgbtagbtag":r"Avg btag of b-tagged jets",
    "avgdrbtag":r"Avg $\Delta$ R between b-tagged jets",
    "avgdr":r"Avg $\Delta$ R between jets",
    "avgdrbtagjet":r"Avg $\Delta$ R between jet and b-tagged jet",
