...
if __name__ == "__main__":
    ...
    if os.environ.has_key("FILE_NAMES"):
        ...
        file_names = ["root://t3dcachedb.psi.ch//pnfs/psi.ch/cms/trivcat/store/user/mameinha/tth/trimmer/TTH_Boosted_v3/GCa3f2dae85dfe/ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8/job_41_out.root"]
    ...
    main(analysis, file_names, sample, "out_compare.root", skip_events, max_events, outfilter)
