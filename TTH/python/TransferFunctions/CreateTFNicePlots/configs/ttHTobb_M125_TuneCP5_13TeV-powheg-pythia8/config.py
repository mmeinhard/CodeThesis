...
def main():
    ...
    #path = "/work/mameinha/tth/gc/transfer/GC2997b3ce756f/"
    path = "/pnfs/psi.ch/cms/trivcat/store/user/mameinha/gc/transfer/GC2997b3ce756f/"
    #path = "file:///mnt/t3nfs01/data01/shome/dsalerno/TTH_2016/TTH_80X_M17/transfer/ttbar"

    #for jettype in ["resolved"]:
    for jettype in ["ttHTobb_M125_TuneCP5_13TeV-powheg-pythia8"]:
