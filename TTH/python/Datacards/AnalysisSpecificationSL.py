...
sl_categories = [
    ...
    Category(
        name = "sl_jge6_tge4",
        cuts = [("numJets", 6, 8), ("nBDeepCSVM", 4, 8)],
        samples = base_samples + ttjets_powheg,
        data_samples = sl_data,
        signal_processes = signal_processes,
        common_shape_uncertainties = common_shape_uncertainties,
    ...
    Category(
        name = "sl_jge6_t3",
        cuts = [("numJets", 6, 8), ("nBDeepCSVM", 3, 4)],
        samples = base_samples + ttjets_powheg,
        data_samples = sl_data,
        signal_processes = signal_processes,
        common_shape_uncertainties = common_shape_uncertainties,
    ...
    Category(
        ...
        cuts = [("numJets", 6, 8), ("nBDeepCSVM", 3, 4), ("btag_LR_4b_2b_btagCSV_logit", blr_cuts["sl_jge6_t3"], 20)],
        samples = base_samples + ttjets_powheg,
        data_samples = sl_data,
        signal_processes = signal_processes,
        common_shape_uncertainties = common_shape_uncertainties,
    ...
    Category(
        ...
        cuts = [("numJets", 6, 8), ("nBDeepCSVM", 3, 4), ("btag_LR_4b_2b_btagCSV_logit", -20, blr_cuts["sl_jge6_t3"])],
        samples = base_samples + ttjets_powheg,
        data_samples = sl_data,
        signal_processes = signal_processes,
        common_shape_uncertainties = common_shape_uncertainties,
    ...
    Category(
        name = "sl_jge6_t2",
        cuts = [("numJets", 6, 8), ("nBDeepCSVM", 2, 3)],
        samples = base_samples + ttjets_powheg,
        data_samples = sl_data,
        signal_processes = signal_processes,
        common_shape_uncertainties = common_shape_uncertainties,
    ...
    Category(
        name = "sl_j5_tge4",
        cuts = [("numJets", 5, 6), ("nBDeepCSVM", 4, 8)],
        samples = base_samples + ttjets_powheg,
        data_samples = sl_data,
        signal_processes = signal_processes,
        common_shape_uncertainties = common_shape_uncertainties,
    ...
    Category(
        name = "sl_j5_t3",
        cuts = [("numJets", 5, 6), ("nBDeepCSVM", 3, 4)],
        samples = base_samples + ttjets_powheg,
        data_samples = sl_data,
        signal_processes = signal_processes,
        common_shape_uncertainties = common_shape_uncertainties,
    ...
    Category(
        name = "sl_j5_t3_blrH",
        cuts = [("numJets", 5, 6), ("nBDeepCSVM", 3, 4), ("btag_LR_4b_2b_btagCSV_logit", blr_cuts["sl_j5_t3"], 20)],
        samples = base_samples + ttjets_powheg,
        data_samples = sl_data,
        signal_processes = signal_processes,
        common_shape_uncertainties = common_shape_uncertainties,
    ...
    Category(
        name = "sl_j5_t3_blrL",
        cuts = [("numJets", 5, 6), ("nBDeepCSVM", 3, 4), ("btag_LR_4b_2b_btagCSV_logit", -20, blr_cuts["sl_j5_t3"])],
        samples = base_samples + ttjets_powheg,
        data_samples = sl_data,
        signal_processes = signal_processes,
        common_shape_uncertainties = common_shape_uncertainties,
    ...
    Category(
        name = "sl_j4_tge4",
        cuts = [("numJets", 4, 5), ("nBDeepCSVM", 4, 8)],
        samples = base_samples + ttjets_powheg,
        data_samples = sl_data,
        signal_processes = signal_processes,
        common_shape_uncertainties = common_shape_uncertainties,
    ...
    Category(
        name = "sl_j4_t3",
        cuts = [("numJets", 4, 5), ("nBDeepCSVM", 3, 4)],
        samples = base_samples + ttjets_powheg,
        data_samples = sl_data,
        signal_processes = signal_processes,
        common_shape_uncertainties = common_shape_uncertainties,
    ...
    Category(
        name = "sl_j4_t3_blrH",
        cuts = [("numJets", 4, 5), ("nBDeepCSVM", 3, 4), ("btag_LR_4b_2b_btagCSV_logit", blr_cuts["sl_j4_t3"], 20)],
        samples = base_samples + ttjets_powheg,
        data_samples = sl_data,
        signal_processes = signal_processes,
        common_shape_uncertainties = common_shape_uncertainties,
    ...
    Category(
        name = "sl_j4_t3_blrL",
        cuts = [("numJets", 4, 5), ("nBDeepCSVM", 3, 4), ("btag_LR_4b_2b_btagCSV_logit", -20, blr_cuts["sl_j4_t3"])],
        samples = base_samples + ttjets_powheg,
        data_samples = sl_data,
        signal_processes = signal_processes,
        common_shape_uncertainties = common_shape_uncertainties,
