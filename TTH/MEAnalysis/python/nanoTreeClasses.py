...
class LHEScaleWeight:
    def __init__(self, tree, n, devVal = None):
...
class LHEReweightingWeight:
    def __init__(self, tree, n, devVal = None):
        #self.id = tree.nLHEReweightingWeight[n];
        if devVal is None:
            self.wgt = tree.LHEReweightingWeight[n];
        else:
            self.wgt = devVal
        pass
    @staticmethod
    def make_array(input):
        return [LHEReweightingWeight(input, i) for i in range(input.nLHEReweightingWeight)]
...
class Muon:
    def __init__(self, tree, n, MC):
        ...
        self.softId = tree.Muon_softId[n];
...
class Jet:
    def __init__(self, tree, n, MC):
        ...
        self.nVertexTracks = tree.JetsVtx_nVertexTracks[n];
        self.VertexFlightDistance = tree.JetsVtx_VertexFlightDistance[n];
        self.VertexErrorFD = tree.JetsVtx_VertexErrorFD[n];
        if MC:
        ...
        self.pt = tree.Jet_pt_nom[n];
        self.rawPt = tree.Jet_pt_raw[n]
        self.mass = tree.Jet_mass_nom[n];
...
class SV:
    def __init__(self, tree,n):
        ...
        self.y = tree.SV_y[n];
        self.z = tree.SV_z[n];
        self.pt = tree.SV_pt[n];
        self.eta = tree.SV_eta[n];
        self.phi = tree.SV_phi[n];
        self.mass = tree.SV_mass[n];
        self.ndof = tree.SV_ndof[n];
        self.pangle = tree.SV_pAngle[n];
        self.dlen = tree.SV_dlen[n];
        pass
    @staticmethod
    def make_array(input):
        return [SV(input, i) for i in range(input.nSV)]
...
class JetsVtx:
    def __init__(self, tree,n):
        self.pt = tree.JetsVtx_pt[n];
        self.mass = tree.JetsVtx_mass[n];
        self.nVertexTracks = tree.JetsVtx_nVertexTracks[n];
        self.VertexFlightDistance = tree.JetsVtx_VertexFlightDistance[n];
        self.VertexErrorFD = tree.JetsVtx_VertexErrorFD[n];
        pass
    @staticmethod
    def make_array(input):
        return [JetsVtx(input, i) for i in range(input.nJetsVtx)]

class IPs:
    def __init__(self, tree,n):
        self.pt = tree.IPs_pt[n];
        self.ip2d = tree.IPs_ip2d[n];
        self.ip2derr = tree.IPs_ip2derr[n];
        self.ip3d = tree.IPs_ip3d[n];
        self.ip3derr = tree.IPs_ip3derr[n];
        self.jetEta = tree.IPs_jetEta[n];
        pass
    @staticmethod
    def make_array(input):
        return [IPs(input, i) for i in range(input.nIPs)]
