...
parset.add_argument("--runMiniAOD", action="store_true", help="If passed script will run from miniAOD and run the nanoAOD step")
...
datasets.update(
    multicrabHelper.getDatasets(
        ...
        filesIdentifier="CMSSW_102X" if args.runMiniAOD else "CMSSW_102X_nano"
    )
)
