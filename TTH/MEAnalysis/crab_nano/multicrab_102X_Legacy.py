...
#ttbarJSON_2016 = ["","",""]
ttbarJSON_2017 = [ "/work/mameinha/testcrab/CMSSW_10_2_15_patch2/src/TTH/MEAnalysis/crab_nano/SplitJSON_TTToHadronic_TuneCP5_PSweights_13TeV_0.json",
                   "/work/mameinha/testcrab/CMSSW_10_2_15_patch2/src/TTH/MEAnalysis/crab_nano/SplitJSON_TTToHadronic_TuneCP5_PSweights_13TeV_1.json",
                   "/work/mameinha/testcrab/CMSSW_10_2_15_patch2/src/TTH/MEAnalysis/crab_nano/SplitJSON_TTToHadronic_TuneCP5_PSweights_13TeV_2.json",
]
...
# -eptonic_tthad_2017: Run TT FH sample (separate because it needs to be split into 3 jobs)
# -leptonic_tthad_2017_v2: Run TT FH sample (separate because it needs to be split into 3 jobs)
...
for k in datasets.keys():
    if ("Double" in k or "Single" in k or "MuonEG" in k) and "2017" in k:
...
for k in datasets.keys():
    if "2017" in k:
        if k.replace("_2017","") in [
                ...
                #"TTGJets",
                #"QCD200to300","QCD300to500","QCD500to700","QCD700to1000","QCD1000to1500","QCD1500to2000","QCD2000toInf"
                ]:
            D = deepcopy(datasets[k])
...
workflow_datasets["leptonic_tthad_2017"] = {}
for k in datasets.keys():
    #print k
    if k in ["TTbar_had_2017"]:
        for ijson, jsonFile in enumerate(ttbarJSON_2017):
            ...
            #D["maxlumis"] = 1
            ###################
            workflow_datasets["leptonic_tthad_2017"][k+"_json_"+str(ijson)] = D

workflow_datasets["leptonic_tthad_2017_v2"] = {}
for k in datasets.keys():
    if k in ["TTbar_had_2017"]:
        for ijson, jsonFile in enumerate(ttbarJSON_2017):
            if ijson < 2:
            ...
            #D["maxlumis"] = 1
            ###################
            workflow_datasets["leptonic_tthad_2017_v2"][k+"_json_"+str(ijson)] = D

workflow_datasets["leptonic_syst_2017"] = {}
for k in datasets.keys():
    if "2017" in k and "syst" in k:
        ...
        #D["runtime"] = 2
        ###################
        workflow_datasets["leptonic_syst_2017"][k] = D
...
for k in datasets.keys():
    if ("SingleMuon-Run2017B" in k) and "2017" in k:
        D = deepcopy(datasets[k])
        D["perjob"] = 1
        D["runtime"] = 1
        D["mem_cfg"] = deepcopy(me_cfgs["default"])
...
if __name__ == '__main__':
	...
	if args.recovery and not sample in args.recovery:
        ...
        #config.Data.lumiMask = "/work/mameinha/testcrab/CMSSW_10_2_15_patch2/src/TTH/MEAnalysis/data/Cert_294927-306462_13TeV_EOY2017ReReco_Collisions17_JSON_RunB.txt"
